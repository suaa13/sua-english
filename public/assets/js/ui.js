...
const I = {
  ...
  /* 太阳：实心圆盘 + 8 条短光线，整体写成单条 path（morphicons 的形状化只吃 d，
     内联的 <circle> 会被丢弃 —— 圆盘必须自己写成子路径）。
     实心靠 CSS 的 fill，见 app.css `.ts-knob morph-icon svg path`；光线是零面积开放
     子路径，填充不影响它们。光线径向 7.2→10.2，紧贴 r=5 的圆盘，密而不挤。
     旧版是「空心细环 + 离得很远的 8 条短线」，缩到 19px 就成了加载转圈图标。 */
  sun: '<path d="M7 12a5 5 0 0 1 10 0a5 5 0 0 1-10 0zM12 1.8v3M12 19.2v3M1.8 12h3M19.2 12h3M4.79 4.79l2.12 2.12M19.21 19.21l-2.12-2.12M19.21 4.79l-2.12 2.12M4.79 19.21l2.12-2.12"/>',
